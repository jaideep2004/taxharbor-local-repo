...
// 	// ... (keep existing filter and download functions)
...
// 			{/* Keep existing filter and download buttons */}
...
// 								{/* <td>{renderCell(user, "username", user.username)}</td> */}
...
// 											{
// 												services.find((s) => s._id === user.serviceInterest)
// 													?.name
// 											}
// 											<button
// 												className='tax-service-btn'
// 												onClick={() =>
// 													handleAssignService(user._id, user.serviceInterest)
// 												}
// 												disabled={assigningService}>
// 												{assigningService ? "Assigning..." : "Assign Service"}
// 											</button>
// 										</div>
// 									) : (
// 										"No pending requests"
