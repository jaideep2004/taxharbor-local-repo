...
// 		bottom: 0,
// 		// background:
// 		// 	"linear-gradient(45deg, rgba(27, 50, 29, 0.1), rgba(27, 50, 29, 0.05))",
...
// 										variant='h4'
// 										gutterBottom
// 										sx={{ mb: 3, fontWeight: 400, color: "#1b321d" }}>
// 										Get funding from $1,000 - $100,000
// 									</Typography> */}
// 									<Typography
// 										variant='h5'
// 										paragraph
...
// 				{/* CTA Section */}
// 				<Box sx={{ py: 8, bgcolor: "#1b321d", color: "white" }}>
// 					<Container>
						...
						<Box sx={{ maxWidth: 800, mx: "auto", mt: 4 }}>
							{faqs.map((faq, index) => (
								<Accordion
									...
									sx={{ mb: 2 }}>
									<AccordionSummary expandIcon={<ExpandMoreIcon />}>
										<Typography variant='body1' style={{fontWeight:"600"}}>{faq.question}</Typography>
									</AccordionSummary>
									<AccordionDetails>
										<Typography style={{fontSize:"17px"}}>{faq.answer}</Typography>
									</AccordionDetails>
								</Accordion>
							))}
						</Box>
